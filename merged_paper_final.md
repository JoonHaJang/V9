...
**실험 결과.** 7개 시나리오(SMALL_3–LARGE_40) 실험 결과는 \<Table 5\>와 같다. STRESS_100은 §4.3과 다른 포대 구성(6개 포대)에서 시간 제한(10초)을 초과하여 테이블에서 제외하였다.
...
| MEDIUM_20  | 20  | 246 |  476 | 0.0000 | 0.0001 | 0.035 |
| LARGE_40   | 40  | 476 |  912 | 0.0001 | 0.0001 | 0.103 |

**결과 해석.** Root Node Gap은 전 시나리오에 걸쳐 0.0000–0.0001% 범위로 측정되었으며, 모든 인스턴스에서 B\&B가 루트 노드에서 실질적인 분기 없이 종료되었다.
